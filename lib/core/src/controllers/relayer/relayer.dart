...
import 'package:wallet_connect/core/src/controllers/publisher/publisher.dart';
import 'package:wallet_connect/core/src/controllers/publisher/types.dart';
import 'package:wallet_connect/core/src/controllers/relayer/constants.dart';
import 'package:wallet_connect/core/src/controllers/relayer/types.dart';
import 'package:wallet_connect/core/src/controllers/subscriber/constants.dart';
import 'package:wallet_connect/core/src/controllers/subscriber/subscriber.dart';
...
class Relayer with IEvents implements IRelayer {
  ...
  Relayer({
    ...
    this.projectId,
        ...
        // messages =MessageTracker(logger, opts.core),
  ...
  _acknowledgePayload(payload) async {
    final response = formatJsonRpcResult<bool>(payload.id, true);
