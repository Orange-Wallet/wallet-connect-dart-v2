...
class RelayerProtocolOptionsAdapter
    extends TypeAdapter<RelayerProtocolOptions> {
  @override
  final int typeId = 3;

  @override
  RelayerProtocolOptions read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return RelayerProtocolOptions(
  ...
  @override
  void write(BinaryWriter writer, RelayerProtocolOptions obj) {
    writer
      ..writeByte(2)
      ..writeByte(0)
      ..write(obj.protocol)
  ...
  bool operator ==(Object other) =>
      ...
      other is RelayerProtocolOptionsAdapter &&
